        ...
        <View>
          ...
          >
            {summary.totalReturns
              ? `${getSignPaisa(summary.totalReturns).paisa} (${summary.totalReturnsPercentageChange
              }%)`
              : "-"}
          </CustomText>
        </View>
        ...
        <View>
          ...
          >
            {summary.oneDayReturn
              ? `${getSignPaisa(summary.oneDayReturn).paisa} (${summary.dayReturnsPercentageChange
              }%)`
              : "-"}
          </CustomText>
        </View>
